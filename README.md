...
The thought behind the "scroll to move levels" design is that it obviates the need for a button to handle the action, which delivers a more pleasant user experience.
